...
Can you guess the most common ones? The semantics are a different from the `terminal` commands you may be used to...
...
> Download reads from `Leir ... Harris, Life Sci Alliance 2020` study
...
Can you find the links to raw data? You should use a `grep` command!
...
> Download the matrix directly from the HCA portal
