...
```{r eval = FALSE}
source("bin/prepare_Hermann.R")
```
</p></details><br>

### Visualization of clustered and embedded data

- Is the resulting object comparable to the published set? What changed? Which information was provided by the authors and retained? Comment on the `DiffusionMap` embedding vs `PCA`. 
