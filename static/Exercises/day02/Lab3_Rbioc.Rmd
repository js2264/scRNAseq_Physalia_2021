...
That being said, it currently introduces "standards" that are different from those introduced by `Bioconductor`, and `Seurat` is actively kept **away** from the `Bioconductor` ecosystem and from its **inter-operabilty** and **non-redundant** standards.  
